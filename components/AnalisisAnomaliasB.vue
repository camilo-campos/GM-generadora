...
// Mapa de configuración de sensores para Bomba B
const SENSORES_CONFIG = {
  'corriente': { label: 'Corriente', icon: '⚡', unit: 'A' },
  'PREDICCION_CORRIENTE': { label: 'Predicción Corriente', icon: '🔮', unit: 'A' },
  'excentricidad_bomba': { label: 'Excentricidad Bomba', icon: '⚙️', unit: 'mm' },
  'flujo_descarga': { label: 'Flujo Descarga', icon: '💧', unit: 'L/min' },
  'flujo_agua_domo_ap': { label: 'Flujo Agua Domo AP', icon: '💧', unit: 'L/min' },
  'flujo_agua_domo_mp': { label: 'Flujo Agua Domo MP', icon: '💧', unit: 'L/min' },
  'flujo_agua_recalentador': { label: 'Flujo Agua Recalentador', icon: '💧', unit: 'L/min' },
  'flujo_agua_vapor_alta': { label: 'Flujo Agua Vapor Alta', icon: '💧', unit: 'L/min' },
  'presion_agua': { label: 'Presión Agua', icon: '📊', unit: 'bar' },
  'temperatura_ambiental': { label: 'Temp. Ambiental', icon: '🌡️', unit: '°C' },
  'temperatura_agua_alim': { label: 'Temp. Agua Alim', icon: '🌡️', unit: '°C' },
  'temperatura_estator': { label: 'Temp. Estator', icon: '🌡️', unit: '°C' },
  'vibracion_axial_empuje': { label: 'Vibración Axial Empuje', icon: '📳', unit: 'mm/s' },
  'vibracion_x_descanso': { label: 'Vibración X Descanso', icon: '📳', unit: 'mm/s' },
  'vibracion_y_descanso': { label: 'Vibración Y Descanso', icon: '📳', unit: 'mm/s' },
  'voltaje_barra': { label: 'Voltaje Barra', icon: '⚡', unit: 'V' },
  // Predicciones
